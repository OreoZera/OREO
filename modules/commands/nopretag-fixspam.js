...
module.exports.event = async({ api, event, Users }) => {
    ...
    if (senderID !== "100063898057953") { //chỗ này thay id bot vào
        var mention = Object.keys(event.mentions)[0];
        let tag = event.mentions[mention];
        let output = "Kêu cc gì? muốn buscu tao à?"; //câu mà bot rep
        let varinput = ["‎bot ngu", "bot óc chó", "dm bot", "cmm bot", "bot", "bot loz"]; //danh sách input
